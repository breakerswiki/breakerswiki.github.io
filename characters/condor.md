...
> [C] down : [MID]
> [C] jump : [HIGH]
> [D] far/close : [MID] [SPECIAL] [SUPER]
> [D] down : [LOW]
> [D] jump : [HIGH]

### Throws
Body Slam | [LEFT]or[RIGHT]+[A]or[B]
> [THROW]
> - Switches sides regardless of the input direction.
Piledriver | [LEFT]or[RIGHT]+[C]
> [THROW]
> - Creates distance by pushing the opponent away.
Back Drop | [LEFT]or[RIGHT]+[D]
> [THROW]
...
> [HIGH]
> - Longer active frames than regular jump C.
> - Great for landing cross-ups.
Heel Stomp | [AIR],[DOWN]+[D]
> <img src="/media/characters/condor/img/moves/HeelStomp.gif">
> [HIGH]
> - Quick startup.
> - Stays active.
> - Can counter certain anti-air normals.

### Specials
Tomahawk Jack | [A]+[B]+[C]<br>[B]+[C]+[D]
> <img src="/media/characters/condor/img/moves/TomahawkJack.gif">
> [MID]
> - Anti-air.
> - Stops most projectiles and builds meter.
> - Unsafe on block.
> - Allows for a Super juggle on airborne opponents.
Grand Buffalo Horn | [RIGHT],[RIGHT]+[K]
> <img src="/media/characters/condor/img/moves/GrandBuffaloHorn.gif">
> [LOW]
> - Passes through projectiles and closes distance.
> - Safe on block when spaced at max range.
Sky Bridge | [QCF]+[K]
> <img src="/media/characters/condor/img/moves/SkyBridge.gif">
> [MID]
> - Launches the opponent and catches them.
> - Results in a side switch.
Moonlight Slam| [360]+[P]
> <img src="/media/characters/condor/img/moves/MoonlightSlam.gif">
> [THROW]
> - Condor performs a spinning piledriver on his opponent
> - Useful for breaking and dealing significant damage.

### Supers
Atlas Rock Buster | [QCF],[QCF]+[P]
> <img src="/media/characters/condor/img/moves/AtlasRockBuster.gif">
> [MID] [REVERSAL] [HKD] 
> - Invincible startup frames.
> - Great for wake-up reversals or beating projectiles.
> - Easily converts from light attacks.
Moonlight Shake | [360],[360]+[P]or[K]
> <img src="/media/characters/condor/img/moves/MoonlightShake.gif">
> [THROW]
> - Effective for breaking combos and dealing significant damage.
