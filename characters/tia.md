...
> [MID]
> - Deals significant chip damage
> - Continues as long as you keep mashing
Rising Upper | [DP]+[K]
> <img src="/media/characters/tia/img/moves/RisingUpper.gif">
> [MID] [REVERSAL] (light version)
> - Light version can pass through projectiles
> - Heavy version deals slightly more damage
Rapid Gale | [QCF]+[P]
...
### Supers
Rapid Charge | [QCF],[QCF]+[P]
> <img src="/media/characters/tia/img/moves/RapidCharge.gif">
> [MID] [REVERSAL] [HKD] 
> - Passes through projectiles
> - Effective for punishing certain moves due to its quick startup
Burning Revolver | ([AIR])[QCB],[QCB]+[P]
> <img src="/media/characters/tia/img/moves/BurningRevolver.gif">
> [MID] [REVERSAL] [HKD] 
> - Startup invulnerability and large hitbox
> - Effective against jump-ins and cross-up attempts
> - Can also be performed in the air
Cutlass Flasher | [QCF],[QCF]+[K]
> <img src="/media/characters/tia/img/moves/CutlassFlasher.gif">
> [MID] [REVERSAL] [HKD] 
> - Overhead super that can catch unaware opponents
