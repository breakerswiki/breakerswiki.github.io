...
> [HIGH]
> - Overhead
> - High recovery, unsafe on hit and block.
Ryuuei Kyaku | [DOWN]+[B]+[D]
> [LOW] [SUPER]
> - Cancelable slide
> - Safe if cancelled with bomb (236C) with proper spacing
> - Can be used after a dash to travel more distance
> - Kara-cancel with 214P (has few applications)

### Specials
Hiryuu | [QCF]+[P]
> <img src="/media/characters/saizo/img/moves/Hiryuu.gif">
> [MID]
> - Projectile
> - Unsafe at close or point-blank range
Yashagami | [QCB]+[P]
> <img src="/media/characters/saizo/img/moves/Yashagami.gif">
> [MID] [REVERSAL] 
> - Light version has invincible startup
> - Can be used as a strong anti-air or reversal
> - Unsafe on block/hit unless if canceled into super
> - On block, light version can be immediatly follwed with super (236236K) to bait punish attempts.
Engetsuzan | [DP]+[P]
> <img src="/media/characters/saizo/img/moves/Engetsuzan.gif">
> [MID]
> - Anti-air special that covers a large area
> - Light version is faster but has bit less range

### Supers
Musou Shinra | [QCF],[QCF]+[P]
> <img src="/media/characters/saizo/img/moves/MusouShinra.gif">
> [MID] [HKD] 
> - Functions as a projectile and anti-air
> - Enables super loops in the corner.
Musou Tenha | [QCB],[QCB]+[P]
> <img src="/media/characters/saizo/img/moves/MusouTenha.gif">
> [MID] [HKD] 
> - Flame pillar anti-air
> - Light version appears in front, while heavy version tracks the opponent's position.
Senku Ensatsujin | [QCF],[QCF]+[K]
> <img src="/media/characters/saizo/img/moves/SenkuEnsatsujin.gif">
> [MID] [HKD] 
> - Quick startup with invincibility
> - The fastest super in the game
> - Allows you to punish any unsafe moves
> - Usually confirmed after 214A
